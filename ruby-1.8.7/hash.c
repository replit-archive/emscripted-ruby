...
static int
index_i(VALUE key, VALUE value, VALUE *args)
{
...
static VALUE
rb_hash_indexes(int argc, VALUE *argv, VALUE hash)
{
    VALUE indexes;
    int i;
...
static VALUE
env_indexes(int argc, VALUE *argv)
{
    int i;
